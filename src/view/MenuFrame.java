...
public class MenuFrame extends javax.swing.JFrame {
    ...
    public MenuFrame() {
        ...
        setResizable(false);
        setIconImage(Toolkit.getDefaultToolkit().getImage(getClass().getResource("/icons/titleApp.png")));
        cardLayout = (CardLayout) pnlView.getLayout();
        pnlView.add(pnlViewMacDinh,"pnlViewMacDinh");
        cardLayout.show(pnlView, "pnlViewMacDinh");
        lblTitleView.setText("Trang Chủ");
        calendar();
        mouseAction();
        setIcons();
        setLayout();    
      ...
      void setLayout() {
        String[] panelNames = {"pnlViewThongKe", "pnlViewNhanVien", "pnlViewHoaDon", "pnlViewKhachHang", "pnlViewDMK", "pnlViewSanPham","pnlViewMacDinh"};
        String[] labelTitles = {"Thống kê", "Nhân viên", "Hóa đơn", "Khách hàng", "Đổi mật khẩu", "Sản Phẩm","Trang Chủ"};
        JLabel[] labels = {lblThongKe, lblNhanVien, lblHoaDon, lblKhachHang, lblDoiMatKhau, lblSanPham,lblLogo};
        JPanel[] panels = {pnlViewThongKe, pnlViewNhanVien, pnlViewHoaDon, pnlViewKhachHang, pnlViewDMK, pnlViewSanPham,pnlViewMacDinh};
        for (JPanel panel : panels) {
            panel.setBackground(new Color(204,255,205)); // Thay màu các panelView
        }
...
//                    CloseMenu();
                    ...
                    pnlHeader.setBackground(new Color(204,255,206));
                    pnlCalendar.setBackground(new Color(201, 240, 204));
                }
            });
        }
...
//Đóng menu
    ...
    void setIcons() {
        ...
        String[] urlIcon = {
            "/icons/Close_2.png", "/icons/Logo.png", "/icons/Document.png",
            "/icons/Fast Moving Consumer Goods.png", "/icons/Staff.png",
            "/icons/Purchase Order.png", "/icons/Customer.png", "/icons/Change.png",
            "/icons/Logout.png", "/icons/Menu.png", "/icons/Calendar.png"
        };
...
//Tạo đồng hồ
    ...
    private void initComponents() {
        ...
        pnlViewMacDinh = new javax.swing.JPanel();
        pnlViewGiayCT = new javax.swing.JPanel();
        ...
        pnlViewSanPhamLayout.setHorizontalGroup(
            ...
            .addGroup(pnlViewSanPhamLayout.createSequentialGroup()
                .addGap(159, 159, 159)
                .addComponent(giayFrame1, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        javax.swing.GroupLayout pnlViewMacDinhLayout = new javax.swing.GroupLayout(pnlViewMacDinh);
        pnlViewMacDinh.setLayout(pnlViewMacDinhLayout);
        pnlViewMacDinhLayout.setHorizontalGroup(
            pnlViewMacDinhLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGap(0, 1140, Short.MAX_VALUE)
        );
        pnlViewMacDinhLayout.setVerticalGroup(
            pnlViewMacDinhLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGap(0, 640, Short.MAX_VALUE)
        );

        pnlView.add(pnlViewMacDinh, "card9");

        javax.swing.GroupLayout pnlViewGiayCTLayout = new javax.swing.GroupLayout(pnlViewGiayCT);
        pnlViewGiayCT.setLayout(pnlViewGiayCTLayout);
        pnlViewGiayCTLayout.setHorizontalGroup(
            pnlViewGiayCTLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGap(0, 1140, Short.MAX_VALUE)
        );
        pnlViewGiayCTLayout.setVerticalGroup(
            pnlViewGiayCTLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGap(0, 640, Short.MAX_VALUE)
        );

        pnlView.add(pnlViewGiayCT, "card10");
    ...
    private void lblDangXuatMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblDangXuatMouseClicked
                ...
                if (choose == JOptionPane.YES_OPTION) {
                        SignIn_Dialog lgf = new SignIn_Dialog();
                        this.dispose();
                        lgf.setVisible(true);
                    }
    ...
    private view.GiayFrame giayFrame1;
