...
public class SignIn_Dialog extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        pnlMainLogin.setBackground(new java.awt.Color(151, 240, 181));
        ...
        lblCloseSignIn.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/Close_2.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SignIn_Dialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    void validateLogin() {
        ...
        Boolean nv = acc.checkLogin(username, password, vaitro);
        if (nv) {
            JOPane.showMessageDialog(this, "Login successfully!");
            new MenuFrame().setVisible(true);
            this.dispose();
        } else {
            JOPane.showErrorDialog(this, "Check Username,Password or Role", "Error");
        }
    }
