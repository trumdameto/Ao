...
public class HangView extends javax.swing.JFrame {
        ...
        if (row >= 0) {
            ...
            if (confirm) {
                ...
                if (rowHienTai < list.size()) {
                    Hang hang = getForm();
                    hang.setId(hangservice.getHang().get(rowHienTai).getId());
                    hangservice.UpdateHang(hang);
                    list = hangservice.getHang();
                    fillTable();
                    clear();
    ...
    private void btnSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchActionPerformed
        ...
        Hang hang = hangservice.SearchHang(search);
        if (search == null) {
    ...
    private void btnNextPageActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNextPageActionPerformed
        int maxPage = (int) Math.ceil((double) hangservice.getHang().size() / soDong);
        if (soTrang < maxPage) {
            soTrang++;
            fillTable();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HangView.class
