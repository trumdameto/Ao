...
public class NhanVien {
    ...
    private boolean gioitinh=true;//=0
    ...
    public NhanVien(String id, String ma, String ten, boolean gioitinh,String sdt, String diachi, Date ngaysinh, String matkhau, String vaitro, String trangthai) {
        this.id = id;
        this.ma = ma;
        this.ten = ten;
    ...
    public NhanVien(String ma, String ten, boolean gioitinh,String sdt, String diachi, Date ngaysinh, String matkhau, String vaitro, String trangthai) {
        this.ma = ma;
        this.ten = ten;
        this.gioitinh = gioitinh;
        this.sdt = sdt;
